package com.whtech.anuroopjodi.Helper;
...
public class DownloadTask {
    ...
    private class DownloadingTask extends AsyncTask<Void, Void, Void> {
        ...
        /*    progressDialog = new ProgressDialog(context);
            ...
            progressDialog.show();*/
            Helper_Method.showProgressBar(context, "Downloading...");
        }
            ...
            try {
                if (outputFile != null) {
                    ...
                    alertDialogBuilder.setNegativeButton("Open File", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            File pdfFile = new File(Environment.getExternalStorageDirectory() + "/MaziSanadGovOfficer/" + downloadFileName);  // -> filename = maven.pdf
        ...
        protected Void doInBackground(Void... arg0) {
            try {
                ...
                if (new CheckForSDCard().isSDCardPresent()) {
                    ...
                    apkStorage = new File(Environment.getExternalStorageDirectory() + "/" + "MaziSanadGovOfficer");
                } else
