...
public class FeaturedProfileListActivityAdapter extends RecyclerView.Adapter<FeaturedProfileListActivityAdapter.SponsorsHolder> {
    ...
    public FeaturedProfileListActivityAdapter(ArrayList<ListProfileObject> listProfileObjectArrayList) {
        this.listProfileObjectArrayList = listProfileObjectArrayList;
    }

    @Override
    public FeaturedProfileListActivityAdapter.SponsorsHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.shortlisted_adapter_row_item, parent, false);

        return new FeaturedProfileListActivityAdapter.SponsorsHolder(itemView);
    }

    @Override
    public void onBindViewHolder(FeaturedProfileListActivityAdapter.SponsorsHolder holder, @SuppressLint("RecyclerView") final int position) {
        ...
        Log.d("profile_id", "onBindViewHolder: "+listProfileObjectArrayList.get(position).profile_id);
...
//        holder.rlImage.getLayoutParams().width = (int) (cardwidth / 1);
        ...
        Log.d("ProfileImage", "onBindViewHolder: "+listProfileObjectArrayList.get(position).ProfilePhoto);
        ...
        Log.d("ValuesIsIntreasted", "onBindViewHolder: "+listProfileObjectArrayList.get(position).is_interest_sent);
        Log.d("ValuesIsIntreasted", "onBindViewHolder: "+listProfileObjectArrayList.get(position).is_shortlisted);
