...
public class DrinkingAdapter extends RecyclerView.Adapter<DrinkingAdapter.ViewHolder> {
    ...
    public DrinkingAdapter(Context context, ArrayList<CommonYesNoObject> personList) {
