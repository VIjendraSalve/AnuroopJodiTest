...
public class MyProfileViewedMemberListActivityAdapter extends RecyclerView.Adapter<MyProfileViewedMemberListActivityAdapter.SponsorsHolder> {
    ...
    public MyProfileViewedMemberListActivityAdapter(ArrayList<ListProfileObject> listProfileObjectArrayList) {
        this.listProfileObjectArrayList = listProfileObjectArrayList;
    }

    @Override
    public MyProfileViewedMemberListActivityAdapter.SponsorsHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.shortlisted_adapter_row_item, parent, false);

        return new MyProfileViewedMemberListActivityAdapter.SponsorsHolder(itemView);
    }

    @Override
    public void onBindViewHolder(MyProfileViewedMemberListActivityAdapter.SponsorsHolder holder, final int position) {
        ...
        Log.d("Birthdate", "1997-05-10 onBindViewHolder: "+listProfileObjectArrayList.get(position).birthDate +"  Email "+ listProfileObjectArrayList.get(position).emailId);
...
//        holder.rlImage.getLayoutParams().width = (int) (cardwidth / 1);
        ...
        if(listProfileObjectArrayList.get(position).is_shortlisted.equals("1")){
            ...
            holder.tvInterest.setBackground(context.getResources().getDrawable(R.drawable.border_info_button));
        }
        ...
        Log.d("Values23", "onBindViewHolder: "+listProfileObjectArrayList.get(position).is_my_connection);
