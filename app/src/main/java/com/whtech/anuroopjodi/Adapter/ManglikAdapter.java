...
public class ManglikAdapter extends RecyclerView.Adapter<ManglikAdapter.ViewHolder> {
    ...
    public ManglikAdapter(Context context, ArrayList<CommonYesNoObject> personList) {
