...
public class DietAdapter extends RecyclerView.Adapter<DietAdapter.ViewHolder> {
    private ArrayList<DietObject> mPersonList;
    ...
    public void add(int position, DietObject item) {
    ...
    public DietAdapter(Context context, ArrayList<DietObject> personList) {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        holder.rlBackground.getLayoutParams().width = (int) (cardwidth / 3.5);
