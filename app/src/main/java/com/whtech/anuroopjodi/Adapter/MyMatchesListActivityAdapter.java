...
public class MyMatchesListActivityAdapter extends RecyclerView.Adapter<MyMatchesListActivityAdapter.SponsorsHolder> {
    ...
    public MyMatchesListActivityAdapter(ArrayList<ListProfileObject> listProfileObjectArrayList) {
        this.listProfileObjectArrayList = listProfileObjectArrayList;
    }

    @Override
    public MyMatchesListActivityAdapter.SponsorsHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.shortlisted_adapter_row_item, parent, false);

        return new MyMatchesListActivityAdapter.SponsorsHolder(itemView);
    }

    @Override
    public void onBindViewHolder(MyMatchesListActivityAdapter.SponsorsHolder holder, @SuppressLint("RecyclerView") final int position) {
...
//        holder.rlImage.getLayoutParams().width = (int) (cardwidth / 1);
        ...
        holder.tvRequestSend.setOnClickListener(new View.OnClickListener() {
                                                    @Override
                                                    public void onClick(View view) {
    ...
    private void confirmation_alert(final String memberId, final int position1, SponsorsHolder holder) {
        ...
        alertDialog.setPositiveButton(R.string.yes, new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                shortListUser(memberId, position1,holder);
            }
        });
    ...
    private void shortListUser(String memberId, final int position, SponsorsHolder holder) {
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                try {
                    ...
                    if (res) {
                        ...
                        listProfileObjectArrayList.get(position).is_shortlisted= "1";
                        holder.tvSendIntrested.setVisibility(View.GONE);
                        holder.tvShortlisted.setVisibility(View.VISIBLE);
