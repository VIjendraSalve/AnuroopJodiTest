...
import com.whtech.anuroopjodi.Adapter.MyConnectionListActivityAdapter;
...
public class MyConnectionListActivity extends BaseActivity implements View.OnClickListener,
        SwipeRefreshLayout.OnRefreshListener, MyConnectionListActivityAdapter.RefreshActivity {
    ...
    private MyConnectionListActivityAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_connection_list);

        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        TextView toolbar_title = toolbar.findViewById(R.id.toolbar_title);
        toolbar_title.setText("My Connections");
    ...
    private void getMyConnection() {
        ...
        final Call<ResponseBody> result = api.matchingProfiles(
                SharedPref.getPrefs(MyConnectionListActivity.this, IConstant.USER_ID)
        );
                ...
                try {
                    ...
                    if (res) {
                       /* remainingCount = Integer.parseInt(jsonObject.getString("remaining"));
                        ...
                        JSONArray jsonArray = jsonObject.getJSONArray("my_connections");
                        // Parsing json
    ...
    private void init() {
        ...
        progressDialog = new ProgressDialog(MyConnectionListActivity.this);
        progressDialog.setProgressStyle(ProgressDialog.STYLE_SPINNER);
        progressDialog.setMessage(getResources().getString(R.string.loading));
        progressDialog.setCancelable(true);


        recyclerView = (RecyclerView) findViewById(R.id.recycler_view_my_connection_list);
        mAdapter = new MyConnectionListActivityAdapter(filteredlistProfileObjectArrayList, MyConnectionListActivity.this);
    ...
    private interface GetOrderAPI {
        ...
        @FormUrlEncoded
        @POST(MyConfig.BrahminMatrimony + "/app_my_connection_list")
