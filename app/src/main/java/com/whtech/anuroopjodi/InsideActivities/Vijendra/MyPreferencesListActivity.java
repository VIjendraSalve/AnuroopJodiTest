...
import com.whtech.anuroopjodi.Adapter.MyPrefrencesListActivityAdapter;
...
public class MyPreferencesListActivity extends BaseActivity implements View.OnClickListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    private MyPrefrencesListActivityAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_prefrences_list);

        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        TextView toolbar_title = toolbar.findViewById(R.id.toolbar_title);
        toolbar_title.setText("My Preferences");
    ...
    private void getMyMatches() {
        ...
        GetOrderAPI api = MyConfig.getRetrofit(IUrls.BASE_URL).create(GetOrderAPI.class);
        final Call<ResponseBody> result = api.matchingProfiles(
                SharedPref.getPrefs(MyPreferencesListActivity.this, IConstant.USER_ID)
        );
    ...
    private void init() {
        ...
        progressDialog = new ProgressDialog(MyPreferencesListActivity.this);
        ...
        mAdapter = new MyPrefrencesListActivityAdapter(filteredlistProfileObjectArrayList);
