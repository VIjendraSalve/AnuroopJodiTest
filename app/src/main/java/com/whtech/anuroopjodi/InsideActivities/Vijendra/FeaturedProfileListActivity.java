...
import com.whtech.anuroopjodi.Adapter.FeaturedProfileListActivityAdapter;
...
public class FeaturedProfileListActivity extends BaseActivity implements View.OnClickListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    private FeaturedProfileListActivityAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_featured_profile_list);

        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        TextView toolbar_title = toolbar.findViewById(R.id.toolbar_title);
        toolbar_title.setText("Featured Profiles");
    ...
    private void getFeaturedProfileList() {
        progressDialog.show();
        filteredlistProfileObjectArrayList.clear();
        Log.d(TAG, "UserID: "+ SharedPref.getPrefs(FeaturedProfileListActivity.this, IConstant.USER_ID));
        ...
        final Call<ResponseBody> result = api.matchingProfiles(
                SharedPref.getPrefs(FeaturedProfileListActivity.this, IConstant.USER_ID)
        );
        result.enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                try {
                    ...
                    Log.d("my_tag3223", "onResponse11: " + output);
                    ...
                    if (res) {
                       /* remainingCount = Integer.parseInt(jsonObject.getString("remaining"));
                        ...
                        JSONArray jsonArray = jsonObject.getJSONArray("blocked_profiles");
                        // Parsing json
    ...
    private void init() {
        ...
        progressDialog = new ProgressDialog(FeaturedProfileListActivity.this);
        progressDialog.setProgressStyle(ProgressDialog.STYLE_SPINNER);
        progressDialog.setMessage(getResources().getString(R.string.loading));
        progressDialog.setCancelable(true);


        recyclerView = (RecyclerView) findViewById(R.id.recycler_view_featured_list);
        mAdapter = new FeaturedProfileListActivityAdapter(filteredlistProfileObjectArrayList);
    ...
    private interface GetOrderAPI {
        ...
        @FormUrlEncoded
        @POST(MyConfig.BrahminMatrimony + "/app_featured_profiles")
