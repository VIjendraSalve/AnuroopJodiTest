...
import com.whtech.anuroopjodi.Adapter.MyRequestListActivityAdapter;
...
public class MyRequestListActivity extends BaseActivity implements View.OnClickListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    private MyRequestListActivityAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar_title.setText("Interest Received");
    ...
    private void getMyRequest() {
        ...
        Log.d(TAG, "UserID: "+SharedPref.getPrefs(MyRequestListActivity.this, IConstant.USER_ID));

        final Call<ResponseBody> result = api.matchingProfiles(
                SharedPref.getPrefs(MyRequestListActivity.this, IConstant.USER_ID)
        );
    ...
    private void init() {
        ...
        progressDialog = new ProgressDialog(MyRequestListActivity.this);
        progressDialog.setProgressStyle(ProgressDialog.STYLE_SPINNER);
        progressDialog.setMessage(getResources().getString(R.string.loading));
        progressDialog.setCancelable(true);


        recyclerView = (RecyclerView) findViewById(R.id.recycler_view_my_request_list);
        mAdapter = new MyRequestListActivityAdapter(filteredlistProfileObjectArrayList);
    ...
    private interface GetOrderAPI {
        ...
        @FormUrlEncoded
        @POST(MyConfig.BrahminMatrimony + "/app_interest_received_list")
