...
import com.whtech.anuroopjodi.Adapter.MyBlockListActivityAdapter;
...
public class MyBlockListActivity extends BaseActivity implements View.OnClickListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    private MyBlockListActivityAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar_title.setText("My Blocked List");
    ...
    private void getMyBlockList() {
        ...
        final Call<ResponseBody> result = api.matchingProfiles(
                SharedPref.getPrefs(MyBlockListActivity.this, IConstant.USER_ID)
        );
    ...
    private void init() {
        ...
        progressDialog = new ProgressDialog(MyBlockListActivity.this);
        progressDialog.setProgressStyle(ProgressDialog.STYLE_SPINNER);
        progressDialog.setMessage(getResources().getString(R.string.loading));
        progressDialog.setCancelable(true);


        recyclerView = (RecyclerView) findViewById(R.id.recycler_view_my_block_list);
        mAdapter = new MyBlockListActivityAdapter(filteredlistProfileObjectArrayList);
    ...
    private interface GetOrderAPI {
        ...
        @FormUrlEncoded
        @POST(MyConfig.BrahminMatrimony + "/app_blocked_user_list")
