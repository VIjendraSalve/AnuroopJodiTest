...
import com.whtech.anuroopjodi.Adapter.MyMatchesListActivityAdapter;
...
public class MyMatchesListActivity extends BaseActivity implements View.OnClickListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar_title.setText("Viewed Matches");
    ...
    private void getMyMatches() {
        ...
        final Call<ResponseBody> result = api.matchingProfiles(
                SharedPref.getPrefs(MyMatchesListActivity.this, IConstant.USER_ID)
        );
                ...
                try {
                    ...
                    if (res) {
                       /* remainingCount = Integer.parseInt(jsonObject.getString("remaining"));
                        ...
                        JSONArray jsonArray = jsonObject.getJSONArray("viewed_profiles");
                        // Parsing json
    ...
    private void init() {
        ...
        progressDialog = new ProgressDialog(MyMatchesListActivity.this);
