...
import com.whtech.anuroopjodi.Adapter.InterestSentListActivityAdapter;
...
public class InterestSentListActivity extends BaseActivity implements View.OnClickListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    private InterestSentListActivityAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_interest_sent_list);

        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        TextView toolbar_title = toolbar.findViewById(R.id.toolbar_title);
        toolbar_title.setText("Interest Sent");
    ...
    private void getMyRequest() {
        ...
        Log.d(TAG, "USER_ID: "+SharedPref.getPrefs(InterestSentListActivity.this, IConstant.USER_ID));
        ...
        final Call<ResponseBody> result = api.matchingProfiles(
                SharedPref.getPrefs(InterestSentListActivity.this, IConstant.USER_ID)
        );
    ...
    private void init() {
        ...
        progressDialog = new ProgressDialog(InterestSentListActivity.this);
        progressDialog.setProgressStyle(ProgressDialog.STYLE_SPINNER);
        progressDialog.setMessage(getResources().getString(R.string.loading));
        progressDialog.setCancelable(true);


        recyclerView = (RecyclerView) findViewById(R.id.recycler_view_interest_sent_list);
        mAdapter = new InterestSentListActivityAdapter(filteredlistProfileObjectArrayList);
    ...
    private interface GetOrderAPI {
        ...
        @FormUrlEncoded
        @POST(MyConfig.BrahminMatrimony + "/app_interest_sent_list")
