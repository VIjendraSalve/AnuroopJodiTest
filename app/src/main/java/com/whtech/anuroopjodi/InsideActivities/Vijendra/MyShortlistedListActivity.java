...
import com.whtech.anuroopjodi.Adapter.MyShortlistedListActivityAdapter;
...
public class MyShortlistedListActivity extends BaseActivity implements View.OnClickListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    private MyShortlistedListActivityAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_shortlisted_list);

        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        TextView toolbar_title = toolbar.findViewById(R.id.toolbar_title);
        toolbar_title.setText("My Shortlisted");
    ...
    private void getShortListedList() {
        progressDialog.show();
        ...
        final Call<ResponseBody> result = api.matchingProfiles(
                SharedPref.getPrefs(MyShortlistedListActivity.this, IConstant.USER_ID)
        );
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                try {
                    ...
                    if (res) {
                        ...
                        JSONArray jsonArray = jsonObject.getJSONArray("shorlisted_profiles");
                        // Parsing json
    ...
    private void init() {
        ...
        progressDialog = new ProgressDialog(MyShortlistedListActivity.this);
        ...
        mAdapter = new MyShortlistedListActivityAdapter(filteredlistProfileObjectArrayList);
    ...
    private interface GetOrderAPI {
        ...
        @FormUrlEncoded
        @POST(MyConfig.BrahminMatrimony + "/app_shortlisted_profiles")
