package com.whtech.anuroopjodi.my_library;
...
public class Constants {
    ...
    public static final String IsPlanExpired = "IsPlanExpired";
    public static final String PACKAGE_ID = "PACKAGE_ID";
    public static final String PACKAGE_NAME = "PACKAGE_NAME";
    public static final String TotalMobileViews = "TotalMobileViews";
    public static final String TotalEmailViews = "TotalEmailViews";
    public static final String UsedMobileViews = "UsedMobileViews";
    public static final String UsedEmailViews = "UsedEmailViews";
    public static final String ConnectionCount = "ConnectionCount";
    public static final String ShortlistCount = "ShortlistCount";
    public static final String RequestReceivedCount = "RequestReceivedCount";
