...
public class MyBlockListActivityAdapter extends RecyclerView.Adapter<MyBlockListActivityAdapter.SponsorsHolder> {
    ...
    public MyBlockListActivityAdapter(ArrayList<ListProfileObject> listProfileObjectArrayList) {
        this.listProfileObjectArrayList = listProfileObjectArrayList;
    }

    @Override
    public MyBlockListActivityAdapter.SponsorsHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.connections_adapter_row_item, parent, false);

        return new MyBlockListActivityAdapter.SponsorsHolder(itemView);
    }

    @Override
    public void onBindViewHolder(MyBlockListActivityAdapter.SponsorsHolder holder, final int position) {
...
//                listProfileObjectArrayList.get(position).city_name +", "+
    ...
    private void confirmation_alert(final String memberId, final int position1) {
        ...
        alertDialog.setPositiveButton(R.string.yes, new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                UnblockUser(memberId, position1);
            }
        });
    ...
    private void UnblockUser(String memberId, final int position) {
