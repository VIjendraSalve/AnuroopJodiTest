...
public class MaritalStatusAdapter extends RecyclerView.Adapter<MaritalStatusAdapter.ViewHolder> {
    ...
    public MaritalStatusAdapter(Context context, ArrayList<MaritalStatusObj> personList) {
