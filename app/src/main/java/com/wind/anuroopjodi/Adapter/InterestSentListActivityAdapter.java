...
public class InterestSentListActivityAdapter extends RecyclerView.Adapter<InterestSentListActivityAdapter.SponsorsHolder> {
    ...
    public InterestSentListActivityAdapter(ArrayList<ListProfileObject> listProfileObjectArrayList) {
        this.listProfileObjectArrayList = listProfileObjectArrayList;
    }

    @Override
    public InterestSentListActivityAdapter.SponsorsHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.interest_sentlist_adapter_row_item, parent, false);

        return new InterestSentListActivityAdapter.SponsorsHolder(itemView);
    }

    @Override
    public void onBindViewHolder(InterestSentListActivityAdapter.SponsorsHolder holder, final int position) {
...
//                listProfileObjectArrayList.get(position).city_name +", "+
    ...
    private void confirmation_alert(final String memberId, final int position1) {
        ...
        alertDialog.setMessage("Are you sure, you want to cancel this person request?");
    ...
    private void cancelRequest(String memberId, final int position) {
    ...
    private interface GetOrderAPI {
        ...
        @FormUrlEncoded
        @POST(MyConfig.BrahminMatrimony + "/app_cancel_request")
    ...
    public class SponsorsHolder extends RecyclerView.ViewHolder {
        TextView tvBusinessName, tvAddress, tvCancelRequest,/* tvRatings, tvTotalRatings,*/
