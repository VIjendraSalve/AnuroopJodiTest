...
import com.wind.anuroopjodi.Object.ProfileCreatedForObj;
import com.wind.anuroopjodi.R;

import java.util.ArrayList;

public class ProfileCreatedForAdapter extends RecyclerView.Adapter<ProfileCreatedForAdapter.ViewHolder> {
    private ArrayList<ProfileCreatedForObj> mPersonList;
    ...
    public void add(int position, ProfileCreatedForObj item) {
    ...
    public ProfileCreatedForAdapter(Context context, ArrayList<ProfileCreatedForObj> personList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent,
                                                                 int viewType) {
        // create a new view
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.profile_created_by_adapter_row_item, parent, false);
