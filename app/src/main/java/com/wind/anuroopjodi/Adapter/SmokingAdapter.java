...
public class SmokingAdapter extends RecyclerView.Adapter<SmokingAdapter.ViewHolder> {
    ...
    public SmokingAdapter(Context context, ArrayList<CommonYesNoObject> personList) {
