...
public class PrefredPartenerMaritalStatusAdapter extends RecyclerView.Adapter<PrefredPartenerMaritalStatusAdapter.ViewHolder> {
    private ArrayList<MaritalStatusObj> mPersonList;
    ...
    public void add(int position, MaritalStatusObj item) {
    ...
    public PrefredPartenerMaritalStatusAdapter(Context context, ArrayList<MaritalStatusObj> personList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent,
                                         int viewType) {
        // create a new view
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.marital_status_adapter_row_item, parent, false);
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        holder.tvMonth.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mPersonList.get(position).isSelected()) {
                    mPersonList.get(position).setSelected(false);
                    holder.tvMonth.setTextColor(context.getResources().getColor(R.color.black));
                    final int sdk = android.os.Build.VERSION.SDK_INT;
                    if (sdk < android.os.Build.VERSION_CODES.JELLY_BEAN) {
                        holder.rlBackground.setBackgroundDrawable(ContextCompat.getDrawable(context, R.drawable.border_round_gray));
                    ...
                    mPersonList.get(position).setSelected(true);
                    holder.tvMonth.setTextColor(context.getResources().getColor(R.color.white));
                    final int sdk = android.os.Build.VERSION.SDK_INT;
                    if (sdk < android.os.Build.VERSION_CODES.JELLY_BEAN) {
                        holder.rlBackground.setBackgroundDrawable(ContextCompat.getDrawable(context, R.drawable.border_round_color_primary));
