...
import com.wind.anuroopjodi.Object.ProfileCreatedByObj;
import com.wind.anuroopjodi.R;

import java.util.ArrayList;

public class ProfileCreatedByAdapter extends RecyclerView.Adapter<ProfileCreatedByAdapter.ViewHolder> {
    private ArrayList<ProfileCreatedByObj> mPersonList;
    ...
    public void add(int position, ProfileCreatedByObj item) {
    ...
    public ProfileCreatedByAdapter(Context context, ArrayList<ProfileCreatedByObj> personList) {
