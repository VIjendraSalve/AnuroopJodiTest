...
public class PhysicalStatusAdapter extends RecyclerView.Adapter<PhysicalStatusAdapter.ViewHolder> {
    ...
    private ArrayList<PhysicalStatusObj> mPersonList;
    private SharedPreferences mPref;
    private SharedPreferences.Editor mEditor;
    private Context context;

    public PhysicalStatusAdapter(Context context, ArrayList<PhysicalStatusObj> personList) {
    ...
    public void add(int position, PhysicalStatusObj item) {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        Log.d("LeavesAdapter", "onBindViewHolder: " + SharedPref.getPrefs(context, IConstant.DISABILITY));
