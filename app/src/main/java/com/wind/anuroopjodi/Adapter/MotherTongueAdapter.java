...
public class MotherTongueAdapter extends RecyclerView.Adapter<MotherTongueAdapter.MyViewHolder> {
    ...
    public static ArrayList<MotherTongueObject> educationObjectArrayList;
    private Context mContext;
    private static CheckBox lastChecked = null;
    private static int lastCheckedPos = 0;


    public MotherTongueAdapter(Context mContext, ArrayList<MotherTongueObject> educationObjectArrayList) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        ...
        holder.checkBox.setText(educationObjectArrayList.get(position).languageName);
