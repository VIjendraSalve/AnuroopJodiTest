...
public class MyPrefrencesListActivityAdapter extends RecyclerView.Adapter<MyPrefrencesListActivityAdapter.SponsorsHolder> {
    ...
    public MyPrefrencesListActivityAdapter(ArrayList<ListProfileObject> listProfileObjectArrayList) {
        this.listProfileObjectArrayList = listProfileObjectArrayList;
    }

    @Override
    public MyPrefrencesListActivityAdapter.SponsorsHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.shortlisted_adapter_row_item, parent, false);

        return new MyPrefrencesListActivityAdapter.SponsorsHolder(itemView);
    }

    @Override
    public void onBindViewHolder(MyPrefrencesListActivityAdapter.SponsorsHolder holder, final int position) {
        ...
        long elapsedYears = 0;
        if(listProfileObjectArrayList.get(position).birthDate != null && !listProfileObjectArrayList.get(position).birthDate.equals("null")
